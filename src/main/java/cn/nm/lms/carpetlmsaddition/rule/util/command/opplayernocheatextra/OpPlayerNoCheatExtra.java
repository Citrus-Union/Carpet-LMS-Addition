 ...
 */
package cn.nm.lms.carpetlmsaddition.rule.util.command.opplayernocheatextra;
...
public final class OpPlayerNoCheatExtra
{
    ...
    {
        return !OpPlayerNoCheatExtraRule.opPlayerNoCheatExtra || !(source.getEntity() instanceof ServerPlayer);
    }
}
