 ...
 */
package cn.nm.lms.carpetlmsaddition.rule.recipes.furnace.shulkerbox;
...
public final class ShulkerBoxFurnaceService
{
    ...
    {
        if ("false".equals(ShulkerBoxFurnaceRule.shulkerBoxFurnace))
        {
            return false;
        }
        ...
        boolean strict = "strict".equals(ShulkerBoxFurnaceRule.shulkerBoxFurnace);
        ...
        boolean canProcess = result != null && canBurn(
                entity.items,
    ...
    )
    {
        ...
        )
        {
            ...
            Optional<RecipeHolder<SmeltingRecipe>> recipeOpt = level.recipeAccess()
                                                                    .getRecipeFor(
                                                                            RecipeType.SMELTING,
                                                                            input,
                                                                            level
    ...
    private static void consumeFuel(NonNullList<ItemStack> items, ItemStack fuel)
    {
        ...
        if (fuel.isEmpty())
        {
            ...
            items.set(
                    SLOT_FUEL,
                    craftingRemainder != null ? craftingRemainder.create() : ItemStack.EMPTY
            );
            //#else
